...
void main() {
  group('surface primitive contracts', () {
    testWidgets('interactive cards expose state and support keyboard activation', (
      tester,
    ) async {
    ...
    testWidgets('typed menu announces its action and returns the selected value', (
      tester,
    ) async {
      final semantics = tester.ensureSemantics();
      int? selected;
    ...
    testWidgets('progress and avatar expose deterministic read-only semantics', (
      tester,
    ) async {
      final semantics = tester.ensureSemantics();
