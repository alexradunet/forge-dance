/// Forge.dance Design System Sizes
/// Component sizing tokens from HTML mockups
class AppSizes {
  AppSizes._();
  ...
  /// Minimum touch target - AAA accessibility standard
  ...
  /// Bottom navigation bar height (from HTML mockup)
  static const double bottomNavHeight = 84.0;

  /// App bar height
  static const double appBarHeight = 56.0;

  /// FAB size (from HTML mockup - 72px)
  static const double fabSize = 72.0;

  /// Small FAB size
  static const double fabSizeSm = 56.0;
  ...
  /// Standard card width
  static const double cardStandardWidth = 280.0;
  ...
  /// Square tile size (medium)
  static const double squareTileMd = 120.0;

  /// Square tile size (large)
  static const double squareTileLg = 160.0;
  ...
  static const double toggleThumbSize = 20.0;
