    ...
    body: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildNeutralRow('Neutral 50', '#F9FAFB', AppColors.neutral50,
              'High Contrast Text'),
          _buildNeutralRow('Neutral 200', '#E5E5E5', AppColors.neutral200,
              'Borders / Dividers'),
          _buildNeutralRow(
              'Neutral 400', '#A3A3A3', AppColors.neutral400, 'Disabled Text'),
          _buildNeutralRow('Neutral 600', '#525252', AppColors.neutral600,
              'Secondary Icons'),
          _buildNeutralRow(
              'Neutral 800', '#262626', AppColors.neutral800, 'Card Surface'),
          _buildNeutralRow(
              'Neutral 950', '#0A0A0A', AppColors.neutral950, 'App Background'),
        ],
      ),
    ),
  );
