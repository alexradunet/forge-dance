...
Widget _buildBodyCard(
    String label, String sizeInfo, TextStyle style, String text) {
  return Container(
      ...
      children: [
        ...
        RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(
                  text: 'const ', style: TextStyle(color: AppColors.forgeFire)),
              ...
              TextSpan(
                  text: '1.0', style: TextStyle(color: AppColors.electricBlue)),
              const TextSpan(text: ',\n'),
              const TextSpan(text: '  status: '),
              TextSpan(
                  text: 'true', style: TextStyle(color: AppColors.forgeFire)),
              const TextSpan(text: '\n};'),
            ],
          ),
        ),
