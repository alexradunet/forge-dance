...
class SwipeableCardScreenTemplate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FgBackground(
        child: SafeArea(
          // SafeArea(top: true) will ensure the whole content is shifted below the notch.
          // Children inside (like AppHeader) will see MediaQuery.padding.top as 0.
          bottom: false,
          child: Column(
            children: [
              // Header
              ...
              if (actionZone != null) ...[
                ...
                const SizedBox(
                    height: 100), // Height of BottomNav + some padding
            ],
          ),
        ),
      ),
