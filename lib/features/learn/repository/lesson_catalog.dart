  ...
  lessons: [
    Lesson(
      ...
      steps: [
        ...
        LessonStep(
          title: 'STACK THE SPINE',
          description: 'Posture is the frame every isolation hangs on.',
          focus: 'Stack ears over shoulders over hips over ankles.',
          breath: 'Inhale to lengthen the spine, exhale to drop the shoulders.',
          energy: 'Tall without stiffness — a puppet string, not a rod.',
        ),
        LessonStep(
        ...
        LessonStep(
          title: 'POSTURE RECALL',
          description: 'Lock the checklist in before the moving lessons.',
          focus: 'Run the full posture stack from memory, eyes closed.',
          breath: 'One slow breath per checkpoint.',
          energy: 'Calm and precise — finish centered.',
        ),
      ],
    ),
    Lesson(
      id: 'body-control-1-chest-isolations',
      title: 'Chest Isolations',
      type: LessonType.movement,
      duration: '10 min',
      steps: [
        LessonStep(
          title: 'RIBCAGE WAKE-UP',
          description: 'Find the ribcage as its own moving part.',
          focus: 'Slide the chest forward and back without the hips joining.',
          breath: 'Exhale as the chest presses forward.',
          energy: 'Gentle range — wake it up, do not force it.',
        ),
        LessonStep(
          title: 'FOUR CORNERS',
          description: 'Map the chest box: forward, right, back, left.',
          focus: 'Hit each corner cleanly before blending them.',
          breath: 'One breath cycle per corner.',
          energy: 'Medium — sharp stops at every corner.',
        ),
        LessonStep(
          title: 'SMOOTH CIRCLES',
          description: 'Blend the corners into one continuous chest circle.',
          focus: 'Erase the corners — no visible stops.',
          breath: 'Circle the breath with the chest, slow and even.',
          energy: 'Fluid and controlled, both directions.',
        ),
        LessonStep(
          title: 'CHEST ON BEAT',
          description: 'Put the isolation into the music.',
          focus: 'Hit the corners on the snare, circle through the melody.',
          breath: 'Sharp exhale on each hit.',
          energy: 'Perform it — chest leads, face relaxed.',
        ),
      ],
    ),
    Lesson(
      id: 'body-control-1-hip-isolations',
      ...
      steps: [
        LessonStep(
          title: 'HIP COMPASS',
          description: 'Map hip travel: front, back, left, right.',
          focus: 'Move the hips without the ribcage drifting along.',
          breath: 'Exhale on each point of the compass.',
          energy: 'Controlled range — precision over size.',
        ),
        LessonStep(
          title: 'FIGURE EIGHTS',
          description: 'Connect the compass points into flowing eights.',
          focus: 'Keep the knees soft so the hips can draw the full shape.',
          breath: 'Slow continuous breathing through the pattern.',
          energy: 'Smooth and heavy — let the hips carry weight.',
        ),
        LessonStep(
          title: 'ISOLATE THE UPPER',
          description: 'Freeze the top while the hips work.',
          focus: 'Shoulders stay square while the hips travel.',
          breath: 'Do not let the breath lift the shoulders.',
          energy: 'Split attention — quiet top, busy bottom.',
        ),
        LessonStep(
          title: 'HIPS IN THE POCKET',
          description: 'Ride the groove with hip accents.',
          focus: 'Land hip hits just behind the beat for pocket feel.',
          breath: 'Breathe with the bassline.',
          energy: 'Confident and loose — this is where style lives.',
        ),
      ],
    ),
    Lesson(
      id: 'body-control-1-shoulder-rolls',
      title: 'Shoulder Rolls',
      type: LessonType.drill,
      duration: '8 min',
      steps: [
        LessonStep(
          title: 'SINGLE ROLLS SLOW',
          description: 'One shoulder at a time, half speed.',
          focus: 'Full circles — up, back, down, forward — no shortcuts.',
          breath: 'Inhale on the way up, exhale on the way down.',
          energy: 'Deliberate, around half power.',
        ),
        LessonStep(
          title: 'ALTERNATING TEMPO',
          description: 'Alternate shoulders at music speed.',
          focus: 'Keep the resting shoulder truly still.',
          breath: 'Match the roll cycle to the eight-count.',
          energy: 'Working pace — steady and repeatable.',
        ),
        LessonStep(
        ...
        LessonStep(
          title: 'SILK FINISH',
          description: 'Close with your smoothest slow-motion rolls.',
          focus: 'Make the circles seamless — no ratchet points.',
          breath: 'Long slow exhales to finish.',
          energy: 'Calm control — leave it silky.',
        ),
      ],
    ),
    Lesson(
      id: 'body-control-1-head-neck',
      title: 'Head & Neck Control',
      type: LessonType.drill,
      duration: '8 min',
      steps: [
        LessonStep(
          title: 'YES-NO-MAYBE',
          description: 'Basic head travel: nod, turn, tilt.',
          focus: 'Move the head without the chest helping.',
          breath: 'Relax the jaw and breathe through the nose.',
          energy: 'Light and careful — necks earn trust slowly.',
        ),
        LessonStep(
          title: 'HEAD SLIDES',
          description: 'The classic side-to-side glide.',
          focus: 'Ears stay level — slide, do not tilt.',
          breath: 'Even breath keeps the neck soft.',
          energy: 'Small clean reps beat big sloppy ones.',
        ),
        LessonStep(
          title: 'TEMPO CONTROL',
          description: 'Slides and turns locked to the beat.',
          focus: 'Hit the slide exactly on the snare.',
          breath: 'Exhale on each accent.',
          energy: 'Snappy but never forced.',
        ),
        LessonStep(
          title: 'QUIET FINISH',
          description: 'Slow everything down and release the neck.',
          focus: 'Trace the slowest possible slide with zero tension.',
          breath: 'Deep slow breaths to release.',
          energy: 'Wind down — the neck should feel free.',
        ),
      ],
    ),
    Lesson(
      id: 'body-control-1-wave-basics',
      title: 'Wave Basics',
      type: LessonType.movement,
      duration: '12 min',
      steps: [
        LessonStep(
          ...
          description: 'A wave is a sequence of checkpoints, not a blur.',
          focus: 'Fingers, wrist, elbow, shoulder — touch each point in order.',
          breath: 'One slow breath per full arm pass.',
          energy: 'Slow-motion learning speed.',
        ),
        LessonStep(
          title: 'ARM WAVE PASSES',
          description: 'Send the wave arm to arm across the chest.',
          focus: 'Hand the wave off through the shoulders without a gap.',
          breath: 'Exhale as the wave crosses the chest.',
          energy: 'Medium — continuous, no restarts.',
        ),
        LessonStep(
          title: 'BODY WAVE',
          description: 'Bring the wave down through chest, hips, and knees.',
          focus: 'Chest leads, hips follow, knees finish.',
          breath: 'Inhale at the top, exhale as it travels down.',
          energy: 'Heavy and smooth — ride the whole spine.',
        ),
        LessonStep(
          title: 'WAVES IN TIME',
          description: 'Fit waves into the musical phrase.',
          focus: 'Start the wave so it lands on the one.',
          breath: 'Time the exhale with the wave landing.',
          energy: 'Expressive — small waves, big waves, play.',
        ),
      ],
    ),
    Lesson(
      id: 'body-control-1-isolation-combos',
      title: 'Isolation Combos',
      type: LessonType.experiment,
      duration: '15 min',
      steps: [
        LessonStep(
          title: 'PICK TWO PARTS',
          description: 'Choose two isolations to combine.',
          focus: 'Start with chest plus hips — the classic pairing.',
          breath: 'Easy breath — this is exploration, not testing.',
          energy: 'Curious and patient.',
        ),
        LessonStep(
          title: 'LAYER THE PARTS',
          description: 'Run both isolations at the same time.',
          focus: 'If one part fails, slow both down together.',
          breath: 'Keep breathing — layering makes people hold air.',
          energy: 'Loose — mistakes are information.',
        ),
        LessonStep(
          title: 'CAPTURE THE COMBO',
          description: 'Keep the layering that worked.',
          focus: 'Repeat your cleanest combo until it needs no thought.',
          breath: 'Reset breath between attempts.',
          energy: 'Focused refinement.',
        ),
        LessonStep(
          title: 'COMBO REMIX',
          description: 'Sequence the combos into a mini phrase.',
          focus: 'Chain three combos with clean transitions.',
          breath: 'Phrase your breath with the sequence.',
          energy: 'Confident finish — perform the phrase once.',
        ),
      ],
    ),
    Lesson(
      id: 'body-control-1-control-showcase',
      title: 'Control Showcase',
      type: LessonType.boss,
      steps: [
        LessonStep(
          title: 'SYSTEMS CHECK',
          description: 'Wake every isolated part before the run.',
          focus: 'Chest, hips, shoulders, head, wave — one pass each.',
          breath: 'Deep steady breaths while you grade your own posture.',
          energy: 'Rising from warm to ready.',
        ),
        LessonStep(
          title: 'THE CONTROL RUN',
          description: 'All isolations in sequence, no stopping.',
          focus: 'Clean checkpoints — anchors quiet, movers sharp.',
          breath: 'Even breath through the transitions.',
          energy: 'Performance level.',
        ),
        LessonStep(
          title: 'MUSICAL PRESSURE',
          description: 'Same run, but the music decides the timing.',
          focus: 'Match isolations to what you hear, not what you planned.',
          breath: 'Sharp exhale on every accent you catch.',
          energy: 'Everything you have — but stay in control.',
        ),
        LessonStep(
          title: 'MASTERY LAP',
          description: 'Close the module like it is yours.',
          focus: 'One freestyle pass using only body control.',
          breath: 'Let it settle naturally.',
          energy: 'Proud and easy — module two is done.',
        ),
      ],
    ),
  ],
