            ...
            child: FgProgressSection(
              ...
              stats: [
                FgStatData(
                  ...
                  value: LocaleKeys.daysValue.tr(
                    args: ['${stats.streakCount}'],
                  ),
                ...
                FgStatData(
                  label: LocaleKeys.forgeNextMilestone.tr(),
                  value: stats.nextBeltName ?? LocaleKeys.maxLevelReached.tr(),
              ...
              levelProgress: FgProgressData(
                ...
                target: 1,
                valueLabel: LocaleKeys.forgeAssessmentProgress.tr(
                  args: ['${(stats.levelProgress * 100).round()}'],
                ),
