  ...
  Widget build(BuildContext context) {
    ...
    return Widgetbook.material(
      directories: [
        ...
        WidgetbookCategory(
          name: 'Atoms',
          children: buildAtomStories(),
        ),
        WidgetbookCategory(
          name: 'Molecules',
          children: buildMoleculeStories(),
        ),
        WidgetbookCategory(
          name: 'Organisms',
          children: buildOrganismStories(),
        ),
        WidgetbookCategory(
          name: 'Templates',
          children: buildTemplateStories(),
        ),
        WidgetbookCategory(
          name: 'Screens',
          children: buildScreenStories(),
        ),
      ],
      addons: [
        MaterialThemeAddon(
          themes: themes,
          initialTheme: themes.last,
        ),
        ViewportAddon(const [
